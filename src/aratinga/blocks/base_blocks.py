...
class ButtonMixin(blocks.StructBlock):
    ...
    button_style = blocks.ChoiceBlock(
        choices=cms_settings.CMS_FRONTEND_BTN_STYLE_CHOICES,
        default=cms_settings.CMS_FRONTEND_BTN_STYLE_DEFAULT,
        required=False,
        label=_("Button Style"),
    )
    button_size = blocks.ChoiceBlock(
        choices=cms_settings.CMS_FRONTEND_BTN_SIZE_CHOICES,
        default=cms_settings.CMS_FRONTEND_BTN_SIZE_DEFAULT,
        required=False,
        label=_("Button Size"),
    )
...
class BaseLayoutBlock(BaseBlock):
    """
    Common attributes for layout blocks used in Aratinga CMS.
    """
