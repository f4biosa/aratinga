...
Aratinga é um sistema de gerenciamento de Conteúdo para internet (*Content Management System* em inglês) em Python / Django e Wagtail.
...
### Vá para: 'http://localhost:8000/admin/' e comece a editar seu site CMS\!
